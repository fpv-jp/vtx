...
customice_agent_find_transport (GstWebRTCICE * ice, GstWebRTCICEStream * stream, GstWebRTCICEComponent component)
{
  GstWebRTCICE *c_ice = GST_WEBRTC_ICE (CUSTOMICE_AGENT (ice)->nice_agent);
...
void
customice_agent_add_candidate (GstWebRTCICE * ice, GstWebRTCICEStream * stream, const gchar * candidate, GstPromise * promise)
{
  GstWebRTCICE *c_ice = GST_WEBRTC_ICE (CUSTOMICE_AGENT (ice)->nice_agent);
...
gboolean
customice_agent_set_remote_credentials (GstWebRTCICE * ice, GstWebRTCICEStream * stream, const gchar * ufrag, const gchar * pwd)
{
  GstWebRTCICE *c_ice = GST_WEBRTC_ICE (CUSTOMICE_AGENT (ice)->nice_agent);
...
gboolean
customice_agent_set_local_credentials (GstWebRTCICE * ice, GstWebRTCICEStream * stream, const gchar * ufrag, const gchar * pwd)
{
  GstWebRTCICE *c_ice = GST_WEBRTC_ICE (CUSTOMICE_AGENT (ice)->nice_agent);
...
gboolean
customice_agent_gather_candidates (GstWebRTCICE * ice, GstWebRTCICEStream * stream)
{
  GstWebRTCICE *c_ice = GST_WEBRTC_ICE (CUSTOMICE_AGENT (ice)->nice_agent);
...
void
customice_agent_set_tos (GstWebRTCICE * ice, GstWebRTCICEStream * stream, guint tos)
{
  GstWebRTCICE *c_ice = GST_WEBRTC_ICE (CUSTOMICE_AGENT (ice)->nice_agent);
...
void
customice_agent_set_on_ice_candidate (GstWebRTCICE * ice, GstWebRTCICEOnCandidateFunc func, gpointer user_data, GDestroyNotify notify)
{
  GstWebRTCICE *c_ice = GST_WEBRTC_ICE (CUSTOMICE_AGENT (ice)->nice_agent);
