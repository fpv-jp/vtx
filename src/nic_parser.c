...
// --- vtx_nic_parse_wpa_cli_command ----------------------------------
JsonObject *vtx_nic_parse_wpa_cli_command(const gchar *output)
{
...
// --- vtx_nic_parse_wpa_json_add_entry ----------------------------------
static void vtx_nic_parse_wpa_json_add_entry(const char *key, const char *value, gpointer user_data)
{
...
void vtx_nic_parse_wpa_json_add_key_values(JsonBuilder *builder, const char *response)
{
  ...
  vtx_nic_parse_wpa_foreach_key_value(response, vtx_nic_parse_wpa_json_add_entry, builder);
}
